...
{   
	...
	LCDDisplayString((BYTE*)"Hello World!! ", LCD_LINE_ONE);	//display the string to line ONE or TWO
	LCDDisplayString((BYTE*)"Line Two :D ", LCD_LINE_TWO);	//display the string to line ONE or TWO
